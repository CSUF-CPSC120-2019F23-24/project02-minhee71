...

{
    ...
    //Concatenate currency_symbol to *_amount strings with to_strings function on *_expenses variables.
    hotel_amount = currency_symbol + std::to_string(hotel_expenses);
    meal_amount = currency_symbol + std::to_string(meal_expenses);
    total_amount = currency_symbol + std::to_string(total_expenses);
